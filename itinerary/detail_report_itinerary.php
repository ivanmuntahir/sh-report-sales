                                ...
                                <div class="col-16-lg mb-2">
                                    <ul class="list-group list-group-horizontal-xl">
                                        <?php
                                            ...
                                            $approvals = [
                                                'status_estimasi_spv' => ['status' => 4, 'label' => 'Supervisor Approved'],
                                                'status_estimasi_m'   => ['status' => 1, 'label' => 'Manager Approved'],
                                                'status_estimasi_gm'  => ['status' => 2, 'label' => 'General Manager Approved'],
                                                'status_estimasi_dir' => ['status' => 3, 'label' => 'Director Approved'],
                                            ];
                                            ...
                                            foreach ($approvals as $field => $data) {
                                                ...
                                                $bgClass = $isApproved ? 'bg-success' : ''; // Add success class if approved
                                                $textClass = $isApproved ? 'text-white' : ''; // Add white text for approved status
                                        ?>
