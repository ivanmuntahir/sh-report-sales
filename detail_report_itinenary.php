                        ...
                        <div class="modal fade" role="dialog" tabindex="-1" id="modal-approve-report">
                            <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="approve_itinenary.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal fade" role="dialog" tabindex="-1" id="modal-edit-comment">
                            <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="comment_itinenary.php" method="POST" enctype="multipart/form-data">
                                        <div class="modal-body">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-0">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="p-2">
                                        <form action="excel_itinenary.php?item_id=<?= $_GET['item_id']; ?>" method="POST" name="export_file_type">
                                            <button type="submit" class="btn btn-primary" name="export_excel_itinenary" value="xls">Export EXCEL</button>
                                        </form>
                                    </div>
                                    <?php
