                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-7">
                                 <label for="select-lapor-ke" class="form-label mb-0 fw-bold">Nama</label>
                                                ...
                                                <select name="input-reports-to-lead-4" class="form-select" id="3-select-lapor-ke">
                                                    <?php if( $user['reports_to_lead_4'] == 0) { ?>
                                                        <option value="" hidden disabled>-</option>
                                                        <?php foreach($users as $temp) { ?>
                                                            <?php if($reports_to_director['id'] == $temp['reports_to_lead_4']) { ?>
                                                                <option value="<?= $reports_to_director['id']; ?>" class="<?="4-option-lapor-ke role-" . $reports_to_gmanager['role'];?>" style="display: none;" selected><?= $reports_to_director['username']; ?></option>
                                                                <?php } else { ?>
