                            ...
                            <div class="table-responsive">
                                ...
                                <?php foreach($users as $user) { ?>
                                    <tr>
                                        ...
                                        <td><?= $user['reports_to_lead_1'] != 0 ? getUser($users, $user['reports_to_lead_1'])['username'] : '-'; ?></td>
                                        <td><?= $user['reports_to_lead_2'] != 0 ? getUser($users, $user['reports_to_lead_2'])['username'] : '-'; ?></td>
                                        <td><?= $user['reports_to_lead_3'] != 0 ? getUser($users, $user['reports_to_lead_3'])['username'] : '-'; ?></td>
                                        <td><?= $user['reports_to_lead_4'] != 0 ? getUser($users, $user['reports_to_lead_4'])['username'] : '-'; ?></td>
